...
class Segment():
    ...
    def regrid_velocity(
        ...
        Args:
            ...
            rotate(bool, optional): Rotate to the model grid, assuming input is on earth grid.
            uvar (str, optional): If provided, use this var from usource, and assume that coordinates are also provided in usource.
            vvar (str, optional): If provided, use this var from vsource, and assume that coordinates are also provided in vsource.
        Returns:
